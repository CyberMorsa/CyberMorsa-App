  ...
  if (!report) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <Button onClick={refreshReport} className="mt-4">
          Intentar de nuevo
        </Button>
      </div>
    )
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-medium text-white">Informe de Seguridad</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-700 p-4 rounded-lg col-span-2">
          <h4 className="text-white font-medium mb-4">Problemas por Categoría</h4>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gray-700 p-4 rounded-lg">
          <h4 className="text-white font-medium mb-4">Distribución de Problemas</h4>
        ...
        <div className="bg-gray-700 p-4 rounded-lg">
          <h4 className="text-white font-medium mb-4">Resumen de Problemas</h4>
